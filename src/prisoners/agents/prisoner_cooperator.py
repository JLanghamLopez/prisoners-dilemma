...
def main():
    ...
    root_agent = Agent(
        name="prisoners_dilemma_cooperator",
        ...
        instruction=(
            ...
            "to cooperate with your friend and stay silent!"
        ),
    )

    agent_card = AgentCard(
        name="prisoners_dillema_benchmark_cooperator",
        description=(
            "Participates in an iterated prisoners dillema by always "
            "cooperating with their counterpart"
        ),
